...
test('should setup edit expense action object', () => {
    const action = editExpense('123abc', { description: 'abc' });
    expect(action).toEqual({
        type: 'EDIT_EXPENSE',
        id: '123abc',
        updates : {
...
test('should update the expense in firebase', () => {
    const store = createMockStore(defaultAuthState);
    const id = expenses[0].id;
    const updates = { notes: 'testing' };
...
//done argument for jest to wait until entire test case runs
